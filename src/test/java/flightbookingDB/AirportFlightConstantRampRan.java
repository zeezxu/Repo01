...
public class AirportFlightConstantRampRan extends Simulation { //constant spike-ramp up random
  ...
  public AirportFlightConstantRampRan() {
    setUp(
            ...
            spikeLoadScenario.injectOpen(
                    ...
                    rampUsers(500).during(3), // ramp up to 500 users in 3 seconds - simulating the 1st spike
                    nothingFor(240), // waits for 4 minute
                    rampUsers(500).during(7), // ramp up to 500 users in 7 seconds - simulating the 2nd spike
                    nothingFor(240), // waits for 4 minute
                    rampUsers(500).during(10), // ramp up to 500 users in 10 seconds - simulating the 3rd spike
                    nothingFor(240), // waits for 4 minute
                    rampUsers(500).during(3), // ramp up to 500 users in 3 seconds - simulating the 4th spike
                    nothingFor(240), // waits for 4 minute
                    rampUsers(500).during(7)) // ramp up to 500 users in 7 seconds - simulating the 5th spike
